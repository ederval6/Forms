object UFrm_Historico: TUFrm_Historico
  ...
  object Pnl_Central: TPanel
    ...
    object DBGrid1: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'Cod_func'
          Title.Caption = 'Codigo funcion'#225'rio'
          Visible = True
        end
        item
          Expanded = False
        ...
        item
          ...
          Title.Caption = 'Modelo descricao'
          Width = 159
          Visible = True
        end
        item
    ...
    object dtpInicial: TDateTimePicker
      ...
      Width = 186
      Height = 23
      Date = 44787.000000000000000000
      Time = 0.832827685182564900
      TabOrder = 3
    end
