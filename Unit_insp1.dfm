object Form_Insp1: TForm_Insp1
  ...
  object Panel1: TPanel
    ...
    object Pnl_Bloco3: TPanel
      ...
      object Edt_Imagem: TDBEdit
        ...
        ShowHint = True
        TabOrder = 0
        OnChange = Edt_ImagemChange
        OnExit = Edt_ImagemExit
      end
  ...
  object Ds_Inspecao: TDataSource
    ...
    OnStateChange = Ds_InspecaoStateChange
    Left = 656
    Top = 80
  end
  ...
  object Ds_Insp_Grid: TDataSource
    DataSet = DM.Ado_Insp_Grid
    Left = 616
    Top = 168
  end
end
